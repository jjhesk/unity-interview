...
public class VehicleDamage : MonoBehaviour 
{
    ...
    public AudioSource hardCrashSound;
    public AudioSource lowCrashSound;
	...
	public void OnCollisionEnter( Collision collision ) 
	{
        ...
        colRelVel.y*= YforceDamp;
            ...
            if (!hardCrashSound.isPlaying && colPointToMe.magnitude > 2)
                {
                    hardCrashSound.Play();
                    hardCrashSound.volume = colStrength / 200;
                }



            if (!lowCrashSound.isPlaying)
                {
                    lowCrashSound.Play();
                    lowCrashSound.volume = colStrength / 100;
