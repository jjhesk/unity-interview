...
void main ()
{
  ...
  xlat_mutable__Color = tmpvar_19;
  xlat_mutable__Color.w = (tmpvar_19.w * (1.0 - (frez * _EdgeAlpha)));
  lowp float tmpvar_20;
  ...
  float tmpvar_22;
  tmpvar_22 = clamp (dot ((textureCube (_Cube, worldRefl).xyz * tmpvar_21), vec3(0.22, 0.707, 0.071)), 0.0, 1.0);
  lowp float tmpvar_23;
  tmpvar_23 = ((_Gloss * tmpvar_11.y) + (tmpvar_20 * tmpvar_11.y));
  lowp float tmpvar_24;
  tmpvar_24 = min ((xlat_mutable__Color.w + (tmpvar_22 * tmpvar_22)), 1.0);
  lowp vec3 tmpvar_25;
  tmpvar_25 = (xlat_mutable__Color.xyz * (1.0 - clamp (tmpvar_21, 0.0, 1.0)));
  mediump vec3 tmpvar_26;
  tmpvar_26 = normalize (xlv_TEXCOORD4);
  lightDir = tmpvar_26;
  ...
  lowp float tmpvar_28;
  tmpvar_28 = texture2D (_LightTexture0, ((xlv_TEXCOORD6.xy / xlv_TEXCOORD6.w) + 0.5)).w;
  lowp float tmpvar_29;
  highp vec3 LightCoord_i0;
  LightCoord_i0 = xlv_TEXCOORD6.xyz;
  highp vec2 tmpvar_30;
  tmpvar_30 = vec2(dot (LightCoord_i0, LightCoord_i0));
  tmpvar_29 = texture2D (_LightTextureB0, tmpvar_30).w;
  lowp float tmpvar_31;
  mediump float shadow;
  lowp vec4 tmpvar_32;
  tmpvar_32 = texture2DProj (_ShadowMapTexture, xlv_TEXCOORD7);
  highp float tmpvar_33;
  if ((tmpvar_32.x < (xlv_TEXCOORD7.z / xlv_TEXCOORD7.w))) {
  ...
  viewDir = tmpvar_27;
  lowp float atten;
  atten = (((float((xlv_TEXCOORD6.z > 0.0)) * tmpvar_28) * tmpvar_29) * tmpvar_31);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_34;
  tmpvar_34 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_35;
  tmpvar_35 = max (tmpvar_34, (abs (tmpvar_34) * (1.0 - tmpvar_24)));
  lowp float tmpvar_36;
  tmpvar_36 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_36;
  mediump float tmpvar_37;
  tmpvar_37 = max (0.0, nh);
  nh = tmpvar_37;
  mediump float tmpvar_38;
  tmpvar_38 = (pow (tmpvar_37, (tmpvar_12 * 128.0)) * tmpvar_23);
  mediump vec3 tmpvar_39;
  tmpvar_39 = ((((tmpvar_25 * _LightColor0.xyz) * tmpvar_35) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_38)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_39;
  mediump float tmpvar_40;
  tmpvar_40 = (tmpvar_24 + (((_LightColor0.w * _SpecColor.w) * tmpvar_38) * atten));
  c_i0_i1.w = tmpvar_40;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  mediump float nh;
  lowp float tmpvar_27;
  tmpvar_27 = dot (tmpvar_12, lightDir);
  lowp float tmpvar_28;
  tmpvar_28 = max (tmpvar_27, (abs (tmpvar_27) * (1.0 - tmpvar_23)));
  lowp float tmpvar_29;
  tmpvar_29 = dot (tmpvar_12, normalize ((lightDir + viewDir)));
  nh = tmpvar_29;
  mediump float tmpvar_30;
  tmpvar_30 = max (0.0, nh);
  nh = tmpvar_30;
  mediump float tmpvar_31;
  tmpvar_31 = (pow (tmpvar_30, ((_Shininess * ((tmpvar_11.x * tmpvar_11.x) * tmpvar_11.x)) * 128.0)) * tmpvar_22);
  mediump vec3 tmpvar_32;
  tmpvar_32 = ((((tmpvar_24 * _LightColor0.xyz) * tmpvar_28) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_31)) * (tmpvar_26 * 2.0));
  c_i0_i1.xyz = tmpvar_32;
  mediump float tmpvar_33;
  tmpvar_33 = (tmpvar_23 + (((_LightColor0.w * _SpecColor.w) * tmpvar_31) * tmpvar_26));
  c_i0_i1.w = tmpvar_33;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  lowp vec4 tmpvar_29;
  tmpvar_29 = texture2D (_LightTexture0, tmpvar_28);
  highp float tmpvar_30;
  tmpvar_30 = ((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97);
  highp vec4 packDist;
  lowp vec4 tmpvar_31;
  tmpvar_31 = textureCube (_ShadowMapTexture, xlv_TEXCOORD7);
  packDist = tmpvar_31;
  highp float tmpvar_32;
  tmpvar_32 = dot (packDist, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp float tmpvar_33;
  if ((tmpvar_32 < tmpvar_30)) {
    tmpvar_33 = _LightShadowData.x;
  } else {
    tmpvar_33 = 1.0;
  };
...
void main ()
{
  ...
  tmpvar_28 = vec2(dot (xlv_TEXCOORD6, xlv_TEXCOORD6));
  lowp vec4 tmpvar_29;
  tmpvar_29 = texture2D (_LightTextureB0, tmpvar_28);
  lowp vec4 tmpvar_30;
  tmpvar_30 = textureCube (_LightTexture0, xlv_TEXCOORD6);
  highp float tmpvar_31;
  tmpvar_31 = ((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97);
  highp vec4 packDist;
  lowp vec4 tmpvar_32;
  tmpvar_32 = textureCube (_ShadowMapTexture, xlv_TEXCOORD7);
  packDist = tmpvar_32;
  highp float tmpvar_33;
  tmpvar_33 = dot (packDist, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp float tmpvar_34;
  if ((tmpvar_33 < tmpvar_31)) {
  ...
  viewDir = tmpvar_27;
  lowp float atten;
  atten = ((tmpvar_29.w * tmpvar_30.w) * tmpvar_34);
  lowp vec4 c_i0_i1;
  mediump float nh;
  lowp float tmpvar_35;
  tmpvar_35 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_36;
  tmpvar_36 = max (tmpvar_35, (abs (tmpvar_35) * (1.0 - tmpvar_24)));
  lowp float tmpvar_37;
  tmpvar_37 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_37;
  mediump float tmpvar_38;
  tmpvar_38 = max (0.0, nh);
  nh = tmpvar_38;
  mediump float tmpvar_39;
  tmpvar_39 = (pow (tmpvar_38, (tmpvar_12 * 128.0)) * tmpvar_23);
  mediump vec3 tmpvar_40;
  tmpvar_40 = ((((tmpvar_25 * _LightColor0.xyz) * tmpvar_36) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_39)) * (atten * 2.0));
  c_i0_i1.xyz = tmpvar_40;
  mediump float tmpvar_41;
  tmpvar_41 = (tmpvar_24 + (((_LightColor0.w * _SpecColor.w) * tmpvar_39) * atten));
  c_i0_i1.w = tmpvar_41;
  c = c_i0_i1;
  c.w = 0.0;
  gl_FragData[0] = c;
...
void main ()
{
  ...
  tmpvar_32 = (xlv_TEXCOORD7.xyz / xlv_TEXCOORD7.w);
  highp vec2 tmpvar_33;
  tmpvar_33 = tmpvar_32.xy;
  lowp float tmpvar_34;
  tmpvar_34 = texture2D (_ShadowMapTexture, (tmpvar_33 + _ShadowOffsets[0].xy)).x;
  shadowVals.x = tmpvar_34;
  highp vec2 tmpvar_35;
  tmpvar_35 = tmpvar_32.xy;
  lowp float tmpvar_36;
  tmpvar_36 = texture2D (_ShadowMapTexture, (tmpvar_35 + _ShadowOffsets[1].xy)).x;
  shadowVals.y = tmpvar_36;
  highp vec2 tmpvar_37;
  tmpvar_37 = tmpvar_32.xy;
  lowp float tmpvar_38;
  tmpvar_38 = texture2D (_ShadowMapTexture, (tmpvar_37 + _ShadowOffsets[2].xy)).x;
  shadowVals.z = tmpvar_38;
  highp vec2 tmpvar_39;
  tmpvar_39 = tmpvar_32.xy;
  lowp float tmpvar_40;
  tmpvar_40 = texture2D (_ShadowMapTexture, (tmpvar_39 + _ShadowOffsets[3].xy)).x;
  shadowVals.w = tmpvar_40;
  bvec4 tmpvar_41;
  tmpvar_41 = lessThan (shadowVals, tmpvar_32.zzzz);
  ...
  tmpvar_49 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_50;
  tmpvar_50 = max (tmpvar_49, (abs (tmpvar_49) * (1.0 - tmpvar_24)));
  lowp float tmpvar_51;
  tmpvar_51 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_51;
  mediump float tmpvar_52;
  tmpvar_52 = max (0.0, nh);
  nh = tmpvar_52;
  mediump float tmpvar_53;
  tmpvar_53 = (pow (tmpvar_52, (tmpvar_12 * 128.0)) * tmpvar_23);
  mediump vec3 tmpvar_54;
  tmpvar_54 = ((((tmpvar_25 * _LightColor0.xyz) * tmpvar_50) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_53)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_54;
  mediump float tmpvar_55;
  tmpvar_55 = (tmpvar_24 + (((_LightColor0.w * _SpecColor.w) * tmpvar_53) * atten));
  c_i0_i1_i2.w = tmpvar_55;
  c = c_i0_i1_i2;
  c.w = 0.0;
  gl_FragData[0] = c;
}
...
void main ()
{
  ...
  highp vec4 packDist;
  lowp vec4 tmpvar_31;
  tmpvar_31 = textureCube (_ShadowMapTexture, vec_i0);
  packDist = tmpvar_31;
  ...
  lowp vec4 tmpvar_32;
  tmpvar_32 = textureCube (_ShadowMapTexture, vec_i0_i1);
  packDist_i0 = tmpvar_32;
  ...
  lowp vec4 tmpvar_33;
  tmpvar_33 = textureCube (_ShadowMapTexture, vec_i0_i1_i2);
  packDist_i0_i1 = tmpvar_33;
  ...
  lowp vec4 tmpvar_34;
  tmpvar_34 = textureCube (_ShadowMapTexture, vec_i0_i1_i2_i3);
  packDist_i0_i1_i2 = tmpvar_34;
  shadowVals.w = dot (packDist_i0_i1_i2, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec4 tmpvar_35;
  tmpvar_35 = vec4(((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97));
  bvec4 tmpvar_36;
  tmpvar_36 = lessThan (shadowVals, tmpvar_35);
  highp vec4 tmpvar_37;
  ...
  viewDir = tmpvar_27;
  lowp float atten;
  atten = (tmpvar_29.w * tmpvar_30);
  lowp vec4 c_i0_i1_i2;
  mediump float nh;
  lowp float tmpvar_44;
  tmpvar_44 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_45;
  tmpvar_45 = max (tmpvar_44, (abs (tmpvar_44) * (1.0 - tmpvar_24)));
  lowp float tmpvar_46;
  tmpvar_46 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_46;
  mediump float tmpvar_47;
  tmpvar_47 = max (0.0, nh);
  nh = tmpvar_47;
  mediump float tmpvar_48;
  tmpvar_48 = (pow (tmpvar_47, (tmpvar_12 * 128.0)) * tmpvar_23);
  mediump vec3 tmpvar_49;
  tmpvar_49 = ((((tmpvar_25 * _LightColor0.xyz) * tmpvar_45) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_48)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_49;
  mediump float tmpvar_50;
  tmpvar_50 = (tmpvar_24 + (((_LightColor0.w * _SpecColor.w) * tmpvar_48) * atten));
...
void main ()
{
  ...
  highp vec4 packDist;
  lowp vec4 tmpvar_32;
  tmpvar_32 = textureCube (_ShadowMapTexture, vec_i0);
  packDist = tmpvar_32;
  shadowVals.x = dot (packDist, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec3 vec_i0_i1;
  vec_i0_i1 = (xlv_TEXCOORD7 + vec3(-0.0078125, -0.0078125, 0.0078125));
  highp vec4 packDist_i0;
  lowp vec4 tmpvar_33;
  tmpvar_33 = textureCube (_ShadowMapTexture, vec_i0_i1);
  packDist_i0 = tmpvar_33;
  shadowVals.y = dot (packDist_i0, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec3 vec_i0_i1_i2;
  vec_i0_i1_i2 = (xlv_TEXCOORD7 + vec3(-0.0078125, 0.0078125, -0.0078125));
  highp vec4 packDist_i0_i1;
  lowp vec4 tmpvar_34;
  tmpvar_34 = textureCube (_ShadowMapTexture, vec_i0_i1_i2);
  packDist_i0_i1 = tmpvar_34;
  shadowVals.z = dot (packDist_i0_i1, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec3 vec_i0_i1_i2_i3;
  vec_i0_i1_i2_i3 = (xlv_TEXCOORD7 + vec3(0.0078125, -0.0078125, -0.0078125));
  highp vec4 packDist_i0_i1_i2;
  lowp vec4 tmpvar_35;
  tmpvar_35 = textureCube (_ShadowMapTexture, vec_i0_i1_i2_i3);
  packDist_i0_i1_i2 = tmpvar_35;
  shadowVals.w = dot (packDist_i0_i1_i2, vec4(1.0, 0.00392157, 1.53787e-005, 0.0));
  highp vec4 tmpvar_36;
  tmpvar_36 = vec4(((length (xlv_TEXCOORD7) * _LightPositionRange.w) * 0.97));
  bvec4 tmpvar_37;
  tmpvar_37 = lessThan (shadowVals, tmpvar_36);
  highp vec4 tmpvar_38;
  ...
  viewDir = tmpvar_27;
  lowp float atten;
  atten = ((tmpvar_29.w * tmpvar_30.w) * tmpvar_31);
  lowp vec4 c_i0_i1_i2;
  mediump float nh;
  lowp float tmpvar_45;
  tmpvar_45 = dot (tmpvar_13, lightDir);
  lowp float tmpvar_46;
  tmpvar_46 = max (tmpvar_45, (abs (tmpvar_45) * (1.0 - tmpvar_24)));
  lowp float tmpvar_47;
  tmpvar_47 = dot (tmpvar_13, normalize ((lightDir + viewDir)));
  nh = tmpvar_47;
  mediump float tmpvar_48;
  tmpvar_48 = max (0.0, nh);
  nh = tmpvar_48;
  mediump float tmpvar_49;
  tmpvar_49 = (pow (tmpvar_48, (tmpvar_12 * 128.0)) * tmpvar_23);
  mediump vec3 tmpvar_50;
  tmpvar_50 = ((((tmpvar_25 * _LightColor0.xyz) * tmpvar_46) + ((_LightColor0.xyz * _SpecColor.xyz) * tmpvar_49)) * (atten * 2.0));
  c_i0_i1_i2.xyz = tmpvar_50;
  mediump float tmpvar_51;
  tmpvar_51 = (tmpvar_24 + (((_LightColor0.w * _SpecColor.w) * tmpvar_49) * atten));
...
Program "fp" {
// Fragment combos: 15
//   opengl - ALU: 69 to 97, TEX: 4 to 10
//   d3d9 - ALU: 73 to 95, TEX: 5 to 11
SubProgram "opengl " {
Keywords { "POINT" "SHADOWS_OFF" }
Vector 0 [_LightColor0]
Vector 1 [_SpecColor]
...
MAX R0.w, R0, R2;
MOV_SAT R1.z, R1;
ADD R2.w, -R1.z, c[10].z;
MUL R0.xyz, R0, R2.w;
DP3 R1.z, fragment.texcoord[5], fragment.texcoord[5];
RSQ R2.w, R1.z;
MUL R1.z, R1.w, R1.y;
MAD R1.w, R1.y, c[6].x, R1.z;
MAD R3.xyz, R2.w, fragment.texcoord[5], R3;
MUL R1.z, R1.x, R1.x;
MUL R2.w, R1.x, R1.z;
DP3 R1.y, R3, R3;
...
MUL R1.xyz, R1, R1.w;
MAD R1.xyz, R0, R0.w, R1;
TXP R0.x, fragment.texcoord[7], texture[6], 2D;
...
dcl_texcoord7 v7
texld r0.yw, v0.zwzw, s1
mad_pp r3.xy, r0.wyzw, c11.x, c11.y
mul_pp r0.x, r3.y, r3.y
mad_pp r0.x, -r3, r3, -r0
...
mul_pp r0.y, r1.x, r0
mov_pp r0.w, r0.x
mul_pp r1.w, r0.y, c5.x
add_pp r0.y, -r1.w, c10
mul_pp r1.x, r0.w, c8
add_pp r0.x, r1, c7
mul_pp r2.w, r0.y, c11.z
mul_pp r1.z, r0.x, r1
texldl r0.xyz, r2, s3
mul_pp r0.xyz, r1.z, r0
...
mul_pp r2.z, r2.y, r2.y
mov_pp r2.x, c10.y
mad_pp r2.x, -r0.w, c3, r2
texld r0, v0, s2
mul_pp r0, r0, c4
mad_pp r2.x, r0.w, r2, r2.z
min_pp r2.w, r2.x, c10.y
dp3_pp r2.y, v4, v4
rsq_pp r0.w, r2.y
mul_pp r2.xyz, r0.w, v4
mov_pp_sat r1.z, r1
...
dp3_pp r1.z, r3, r2
mul_pp r1.w, r1, c11
max_pp r1.z, r1, c10.x
pow_pp r2, r1.z, r1.w
mul_pp r1.x, r1, r1.y
mad_pp r2.y, r1, c6.x, r1.x
mov_pp r1.w, r2.x
mov_pp r1.xyz, c0
mul_pp r1.w, r1, r2.y
mul_pp r1.xyz, c1, r1
...
TEX R0.xyz, R0, texture[3], CUBE;
MUL R0.xyz, R1.z, R0;
DP3_SAT R3.x, R0, c[13];
MOV R2.w, c[11].z;
MAD R2.w, -R0, c[4].x, R2;
TEX R0, fragment.texcoord[0], texture[2], 2D;
MOV_SAT R1.z, R1;
MUL R0, R0, c[5];
MUL R3.x, R3, R3;
...
MUL R1.xyz, R1, R1.w;
MAD R1.xyz, R0, R0.w, R1;
TEX R0, fragment.texcoord[7], texture[4], CUBE;
...
MUL R0.xyz, R0, c[1];
MAD R0.xyz, R0, R0.w, R1;
TEX R1, fragment.texcoord[7], texture[4], CUBE;
...
mul_pp r2.xyz, r2.w, r2
dp3_pp r0.x, r3, r2
mul_pp r0.y, r1.x, c15.w
max_pp r0.x, r0, c14
pow_pp r2, r0.x, r0.y
mul_pp r0.x, r1.w, r1.y
mad_pp r0.y, r1, c10.x, r0.x
mov_pp r0.x, r2
mov_pp r1.xyz, c0
rcp r1.w, v7.w
mul_pp r2.x, r0, r0.y
...
texld r0.x, r1, s6
mad r1, r0, r1.w, c2.x
dp4_pp r0.z, r1, c14.w
rcp r0.x, v6.w
mad r1.xy, v6, r0.x, c14.z
dp3 r0.x, v6, v6
texld r0.w, r1, s4
cmp r0.y, -v6.z, c14.x, c14
mul_pp r0.y, r0, r0.w
...
dcl_texcoord7 v7.xyz
texld r0.yw, v0.zwzw, s1
mad_pp r3.xy, r0.wyzw, c13.x, c13.y
mul_pp r0.x, r3.y, r3.y
mad_pp r0.x, -r3, r3, -r0
add_pp r0.x, r0, c12
rsq_pp r0.x, r0.x
...
mul_pp r0.y, r1.x, r2.w
mov_pp r3.w, r0.x
mul_pp r0.w, r0.y, c6.x
mul_pp r1.x, r3.w, c9
add_pp r0.x, -r0.w, c12
mul_pp r2.w, r0.x, c13.z
add_pp r1.w, r1.x, c8.x
mul_pp r1.w, r1, r1.z
texldl r0.xyz, r2, s3
...
mov_pp_sat r1.w, r1
mul_pp r2, r2, c5
mad_pp r0.y, -r3.w, c4.x, r1.z
mad_pp r1.z, r2.w, r0.y, r0
min_pp r2.w, r1.z, c12.x
add_pp r1.w, -r1, c12.x
mul_pp r2.xyz, r2, r1.w
rsq_pp r0.x, r0.x
mul_pp r0.xyz, r0.x, v4
dp3_pp r1.z, r3, r0
add_pp r3.w, -r2, c12.x
abs_pp r2.w, r1.z
mul_pp r2.w, r2, r3
dp3_pp r4.x, v5, v5
rsq_pp r3.w, r4.x
max_pp r1.z, r1, r2.w
mad_pp r0.xyz, r3.w, v5, r0
dp3_pp r2.w, r0, r0
rsq_pp r2.w, r2.w
mul_pp r0.xyz, r2.w, r0
dp3_pp r0.x, r3, r0
mov_pp r3.xyz, c1
max_pp r1.w, r0.x, c13
mul_pp r2.w, r0, c14
pow_pp r0, r1.w, r2.w
mul_pp r0.y, r1.x, r1
mad_pp r0.y, r1, c7.x, r0
